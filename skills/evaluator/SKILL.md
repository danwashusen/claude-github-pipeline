...
| `story` | `playbooks/story.md` | on merge: close story (the epic's rollup follows), project progress only on a legacy epic, record this story's delivery-log entry; forward handoff |
